...
const Header = () => {
  ...
  const userName = userInfo ? userInfo.name.slice(0, 4) + "..." : "student";
  ...
  return (
    <header className="bg-white  dark:bg-gray-800  shadow ">
      <div className="flex  relative items-center justify-content-between ">
        ...
        <div className="flex-end"></div>
        <Link to="notice" className="pb-20 ml-10 user_info flex items-center ">
          <AiOutlineNotification className="text-2xl  text-green-600" />
          <h6 className="mt-2">Notice</h6>
        </Link>
        <Link to="profile" className="pb-20 mr-10 user_info flex items-center ">
