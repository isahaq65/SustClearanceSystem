...
const Profile = () => {
  ...
  const fillData = () => {
    ...
    data.set("session", profileData.session);
    data.set("fatherName", profileData.fatherName);
          ...
          <div className="row">
            <div className="col-md-4">
              ...
              >
                ...
                <Link to="/dashboard/my-applications" ><a
                  className="nav-link"
                  id="application-tab"
                  data-toggle="pill"
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        {edit ? (
                          ...
                          <>
                            <p className="mt-3"> {userInfo.regNo}</p>
                          </>
                        )}
                      </div>
                    </div>
