...
const CertificateCopy = () => {
  ...
  const openInNewTab = (images) => {
    for (const imageArray of images) {
      console.log(imageArray.image);
      if (imageArray.image.imageDefinition == "bankRecipt") {
  ...
  const findClearance = async(regNo)=>{



    const { result, application  } = await axios.post(
      `admin/clearance-check/${regNo}`,
    ...
    if(result){
      setClearance(true)
      setclearanceId(application.applicationID)
  ...
  useEffect(() => {
    if (userInfo) fetchApplicationData();
    else {
      window.alert("dddd");
    }
  }, []);
          ...
          <div className="transcript-header">
            <div className="transcript-header-content">
              ...
              <div className="transcript-header-item my-10">
                <h6>Application for certificate</h6>
                <hr className="h-line" />
              </div>
            </div>
          </div>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-9">
                <input
                  ...
                  className="border-btm"
                  id="inputPassword"
                  value={applicationData.letterGrade}
                />
              </div>
            </div>
